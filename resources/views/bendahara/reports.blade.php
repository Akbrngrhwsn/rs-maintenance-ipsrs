        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-gray-200">
                <div class="p-6 border-b border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    @if(auth()->user() && auth()->user()->role === 'bendahara')
                    ...
                    @endif
                    <form action="{{ route('bendahara.reports') }}" method="GET" class="flex flex-col sm:flex-row gap-2 w-full md:w-auto">
                        ...
                        @if(request('search') || request('date'))
                            <a href="{{ route('bendahara.reports') }}" class="text-sm text-red-600 hover:underline self-center">Reset</a>
                        @endif
                    </form>
                </div>
